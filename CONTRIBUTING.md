# Contributing to django-sage-contact

Thank you for considering contributing to `django-sage-contact`! We welcome contributions from the community to help make this project better.

## Table of Contents

- [Contributing to pyhton-sage-imap](#contributing-to-django-sage-contact)
...
1. **Fork the repository on GitHub**:
   ...
   Go to the [django-sage-contact](https://github.com/your-username/django-sage-contact) repository and click on the "Fork" button in the top-right corner.

2. **Clone your fork locally**:

   ```bash
   git clone https://github.com/your-username/django-sage-contact.git
   cd django-sage-contact
   ```
...
1. **Go to the [Issues](https://github.com/your-username/django-sage-contact/issues) section of the repository.**
